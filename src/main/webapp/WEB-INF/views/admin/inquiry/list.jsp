		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">1:1 문의 목록</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item active">고객센터> 1:1 문의 목록</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
					                ...
					                <table class="table table-hover text-nowrap">
					                    ...
					                    <tbody>
					                        ...
					                        <tr>
					                            ...
					                            <td>
					                            	<a href="/inquiry/detail?inquiry_idx=<%=inquiry.getInquiry_idx()%>"><%=inquiry.getTitle() %></a>
					                            </td>
					                            <td><%=inquiry.isResult() %></td>
